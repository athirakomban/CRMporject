...
public class ExcelRead {
	...
	public static  String getDataFromExcel(String filePath, String sheetName, int rowNo,int columnNo) throws InvalidFormatException, IOException
	{//here getting excel data to an 2D(3x2) array using getDataFromExcel(path,value)
		// init
		String data="";
		FileInputStream inputStream = new FileInputStream(new File(filePath));
		...
		if (!getCellValue(s, 0, columnNo).equals("")) {
			data= getCellValue(s, rowNo, columnNo);
		}
